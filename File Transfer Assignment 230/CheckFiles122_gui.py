...
def load_gui(self):
    ...
    self.btnBrowse1 = Button(self.master, text="Source...",width=12, height=1,command=lambda: CheckFiles122b_func.askdirectory1(self)) 
    ...
    self.btnBrowse2 = Button(self.master, text="Destination...", width=12, height=1,command=lambda: CheckFiles122b_func.askdirectory2(self))
    self.btnBrowse2.grid(row=1, column=0, padx=(10,10), pady=(20,0), sticky=NW)

    self.btnCheckFiles = Button(self.master, text="Check for files...", width=12, height=2,command=lambda: CheckFiles122b_func.checkfiles(self))
    self.btnCheckFiles.grid(row=2, column=0, padx=(10,10), pady=(20,0), sticky=NW)

    self.btnClose = Button(self.master, text="Close Program", width=12, height=2,command=lambda: CheckFiles122b_func.ask_quit(self))
